...
\begin{rpg-table}[|l|c|X|]
  ...
  Ambidextrous & 1 &  Allows the warrior to make an attack with an off-hand weapon without any penalty.\\
	Awareness & 3 &  When the warrior is aware of an opponent the latter cannot gain a flanking bonus for three combat rounds.\\
	Combat Focus & 2 &  Allows a warrior to make a close combat attack with a Bonus die (+1B).\\
	Combat Mastery & 3 &  Allows a warrior to make a close combat attack with a Bonus die (+1B) and +2 damage. If Combat Focus is already known it can be substituted with this technique with one Improvement Point. \\
	Confuse & 2 &  Can only be used for an attack action and forces the opponent's parry or dodge to be at a Penalty die (-1P).\\
	Deadly Aim & 3 &  Allows a warrior to make a ranged attack with a Bonus die (+1B) and +2 damage. If Impr. Aim is already known it can be substituted with this technique with one IP.\\
	...
	Extra Reaction   & 3 &  The warrior gains an extra reaction in this round with a Penalty die (-1P).\\
	...
	Impr. Intimidate & 2 &  The warrior's intimidate (Influence) gains a Bonus die (+1B).\\
	...
	Twin Missile & 4 &  Allows a warrior to make an additional single ranged attack action at Penalty die (-1P) in quick succession.\\
	Unarmed Fast Attack & 2 &  When unarmed a warrior can make an additional unarmed attack at Penalty die (-1P) in quick succession.\\
	Unarmed Focus & 2 &  Allows a warrior to make an unarmed attack with a Bonus die (+1B).\\
	Unarmed Mastery & 3 &  Allows a warrior to make an unarmed attack with a Bonus die (+1B) and +2 damage. If Unarmed Focus is already known it can be substituted with this technique with one Improvement Point.\\
        \hline
\end{rpg-table}
\end{center}
\end{table*}
...
\begin{figure*}[b]
\begin{center}
\includegraphics[scale=0.45]{img/ai-images/warrior-strong.png}
\end{center}
\end{figure*}
