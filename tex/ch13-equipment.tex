...
\begin{description}
	\item[Type:] This shows how the weapon is wielded and other special rules (see `Close Combat Weapon Types' in page~\pageref{sssec:close-combat-weapon-types}).
...
\begin{description}
	\item[Type:] This shows how the weapon is wielded and other special rules (see `Ranged Combat Weapon Types' in page~\pageref{sssec:ranged-combat-weapon-types}).
	\item[Damage Dice:] The damage the weapon deals on a successful attack. 
