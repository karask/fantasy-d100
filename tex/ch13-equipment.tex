...
These rules do not give detailed rules for trading and fantasy world economics. Although dry economic markets are unlikely to feature heavily in adventure stories, the exploits of daring and wily merchant adventurers are. %The following section outlines how to approach such stories using Fantasy Crux.
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.23]{img/ai-images/shop.png}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.23]{img/ai-images/shields.png}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.23]{img/ai-images/shop-interior.png}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.23]{img/ai-images/carriage.png}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.38]{img/ai-images/river.png}
\end{center}
\end{figure}
