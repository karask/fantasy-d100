...
\begin{rpg-table}[|X|c|c|c|c|c|c|]
  ...
  Crossbow (Light)$^{1}$ & 2H        & 1D8   & 125m     & 5/9  & 1  & 150 SP\\
	...
	\hline
  \multicolumn{7}{|p{\linewidth-4.5mm}|}{1. A heavy crossbow requires a full combat round to reload while a light crossbow requires a movement action (see Combat Chapter for details).}\\
	\hline
\end{rpg-table}
\end{center}
\end{table*}
