...
\subsection{Opportunities for Merchant based Games}
...
\begin{rpg-table}[|X|c|c|c|c|c|c|]
	...
	Broadsword      & 1H             & 1D8   &  9/9  & 2 & Medium & 150 SP\\
...
\begin{description}
	...
	\item[Rate:] This shows how many missiles can be fired per Combat Rounds, taking into consideration the time to load the weapon. For example 1 CR, means 1 missile can be fired every combat round, while 1/3 CR means one 1 missile every 3 combat rounds. 
...
\begin{rpg-table}[|X||c|c|c|c|c|c|c|]
	\hline
	\textbf{Weapon} & \textbf{Type} & \textbf{Damage Dice} & \textbf{Range} & \textbf{Rate} & \textbf{STR/DEX} & \textbf{ENC} & \textbf{Cost}\\
	\hline
	Dagger            & Close/Thrown   & 1D6   & STR x m  & 1 CR   & -/9  & -  & 30 SP\\
	Dart              & Thrown         & 1D4   & STR x m  & 1 CR   & -/9  & -  & 15 SP\\
	Crossbow (Heavy)  & 2H             & 2D6   & 150m     & 1/3 CR & 9/9  & 2  & 350 SP\\
	Crossbow (Light)  & 2H             & 1D8   & 125m     & 1/2 CR & 5/9  & 1  & 150 SP\\
	Hatchet           & Close/Thrown   & 1D6   & STR x m  & 1 CR   & -/9  & 1  & 25 SP\\
	Improvised (Rock) & Thrown         & 1d4   & STR x m  & 1 CR   & 5/5  & 1  & -\\
	Javelin           & Thrown         & 1d6   & STR x 2m & 1 CR   & 5/9  & 1  & 20 SP\\
	Longbow           & 2H             & 1d10  & 150m     & 1 CR   & 13/9 & 1  & 150 SP\\
	Shortbow          & 2H             & 1d8   & 75m      & 1 CR   & 9/9  & 1  & 75 SP\\
	Shortspear        & Close/Thrown   & 1d6   & STR x 2m & 1 CR   & 5/9  & 2  & 20 SP\\
	Sling             & 1H             & 1d6   & 50m      & 1 CR   & -/9  & -  & 5 SP\\
	Whip              & Close          & 1d3   & 5m       & 1 CR   & -/9  & -  & 50 SP\\
	\hline
\end{rpg-table}
\end{center}
\end{table*}
...
\begin{description}
	...
	\item[First Aid Kit:] A first aid kit is good for five uses (whether the skill test succeeds or fails). 
...
\section{Animals and Transportation}
