...
Although in theory many of the monsters in this chapter can be used as player characters the following are especially suited: Dwarf, Elf, Centaur, Goblin, Merman, Orc, Ogre, Lizard Man.
\end{rpg-titlebox}
...
\begin{monsterbox}{Centaur}
	...
	\begin{rpg-monsteraction}[Ranged Combat 70\%]
		Large Longbow (1D10+1D6)
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Close Combat 40\%]
		Lance (1D10+1D6), Shield (1D6+1D6), Arming Sword (1D8+1D6)
	\end{rpg-monsteraction}
...
\begin{monsterbox}{Dwarf}
	...
	\begin{rpg-monsteraction}[Close Combat 65\%]
		War Hammer (1D8), Battleaxe (1D8), Shield (1D6)
	\end{rpg-monsteraction}
...
\begin{monsterbox}{Orc}
	...
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Practical]
		Athletics~35\%, Perception~45\%, Deception~45\%
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Close Combat 40\%]
		Scimitar (1D8), Shield (1D6)
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Ranged Combat 50\%]
		Shortbow (1D8)
	\end{rpg-monsteraction}
