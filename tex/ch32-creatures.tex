...
\begin{monsterbox}{Dragon}
	...
	\begin{rpg-monsteraction}[Breathe Flame]
		...
		The Dragon may only breathe flame once per hour. Further attempts to breathe flame within this time period require the creature to make a Resilience test, with a cumulative penalty die for every attempt.
	\end{rpg-monsteraction}
...
\begin{monsterbox}{Elf}
	...
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Exceptional Archers]
		Elves gain a Bonus die (+1B) when using bows.
	\end{rpg-monsteraction}
...
\begin{monsterbox}{Harpy}
	...
	\end{rpg-monsteraction}
	\rpgmonstersection{Abilities}
	\begin{rpg-monsteraction}[Folk Magic]
...
\begin{monsterbox}{Dryad}
	...
	\end{rpg-monsteraction}
	\rpgmonstersection{Abilities}
	\begin{rpg-monsteraction}[Folk Magic 60\%]
...
\begin{monsterbox}{Hag}
	...
	\end{rpg-monsteraction}
	\rpgmonstersection{Abilities}
	\begin{rpg-monsteraction}[Folk Magic 75\%]
...
\begin{monsterbox}{Oread}
	...
	\end{rpg-monsteraction}
	\rpgmonstersection{Abilities}
	\begin{rpg-monsteraction}[Folk Magic 70\%]
...
\begin{monsterbox}{Healing Spirit}
	...
	\begin{rpg-monsteraction}[Spirit Combat 50\%]
		Spectral Blast (1D6)
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Folk Magic 100\%]
		Heal 6
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Special Rules]
...
\begin{monsterbox}{Skeleton}
	...
	\end{rpg-monsteraction}
	\rpgmonstersection{Abilities}
	\begin{rpg-monsteraction}[Pierce Resistance]
		Skeletons take only half damage from piercing weapons.
	\end{rpg-monsteraction}
	\begin{rpg-monsteraction}[Immunities]
