...
Through their adventures character will earn experience, awarded by the Games Master as a reward for certain achievements. This experience, called Improvement Points, will allow characters to improve.

\subsubsection{Improving Skills}
A player can choose to spend one improvement point to increase one known skill. 
Select the skill to be increased and the skill increases by +5\% points. 
...
During such downtime the characters may improve their characters. The players might actually request downtime between adventures to learn new skills and it is up to the Games Master to determine if this is appropriate.  
