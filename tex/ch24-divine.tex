...
%In order to acquire a particular Divine Magic spell, the caster must possess the Lore (Cult) skill appropriate to his religion and be of Initiate or Priest status within a cult dedicated to that religion. 

%The character must pay a cost in Improvement Points, equal to twice the Magnitude of the spell, to the Deity. This may be done in an incremental fashion, i.e. the player buys Shield 1 for two Improvement Points and then later increases this to Shield 3, by spending an additional four points. These points are not regained, even when the character leaves the religion.
