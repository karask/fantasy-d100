...
When someone becomes a Holy Warrior they are gifted a specially consecrated weapon, that gives them a bonus when fighting to defend fellow worshippers, religion temples, and when attacking enemies of their faith.  This bonus is usually a Bonus die (+1B) to the appropriate weapon skill and double damage when fighting for their Religion. All damage done by such weapons is considered magical.
...
\item[Folk Magic:] Darkwall, Enhance Deception, Extinguish.
\item[Divine Magic:] All common spells, Call Shade, Fear.
\item[Special benefits:] Bonus die (+1B) to Deception during the Night.
\end{description}


\subsubsection{The Sun King}
The bright blazing ruler of the day. The everlasting source of life and light. To some cultures he is the ultimate lawmaker, whose word is to be obeyed without question. Also a source of healing and resurrection.
...
\item[Folk Magic:] Enhance Influence, Fire Missile?, Fire Weapon?, Heal, Light, Multi Missile.
\item[Divine Magic:] All common spells, Call Salamander, Divine Heal, Resurrect, Sun Spear, Sun Disc, Radiant Appearance.
\item[Special benefits:] Bonus die (+1B) to Influence skills when dealing with lower social classes.
\end{description}
...
\item[Folk Magic:] Fanaticism, Extinguish, Vigour, Weapon Enhance.
...
\item[Folk Magic:] Heal, Protection
\item[Divine Magic:] All common spells, Absorption, Berserk, Divine Heal.
\item[Special benefits:] Any member of this cult gains a Bonus die (+1B) to their Nature Lore, due to their connection to Nature, which they gain through their relationship with the Earth Mother.
\end{description}
...
\item[Folk Magic:] Demoralise, Spirit shield, Weapon Enhance.
\item[Divine Magic:] All common spells, Call (Undead), Death March, Resurrect, Touch of Death.
\item[Special benefits:] Bonus die (+1B) when inspecting corpse to determine time and cause of death.
\end{description}
...
\item[Folk Magic:] Detect X, Mindspeech.
\item[Divine Magic:] All common spells, Find X of various types, Soul Sight, See Past.
\item[Special benefits:] Bonus die (+1B) when using a Library to find information.
\end{description}
...
\item[Folk Magic:] Befuddle, Hinder.
\item[Divine Magic:] All common spells, Illusion, Reflection, Purity, Wax Effigy, Puppet, Jigsaw.
\item[Special benefits:] Bonus die (+1B) Deception when playing pranks.
\end{description}
...
\item[Folk Magic:] Clear the Path, Enhance Influence, Enhance Perception.
\item[Divine Magic:] All common spells, Treasury, Ward Camp, Create Crystal Ship.
\item[Special benefits:] Bonus die (+1B) when using Perception or Influence as part of a financial deal.
\end{description}
...
\item[Folk Magic:] Coordination, Fanaticism, Strength, Vigour, Weapon Enhancement. 
\item[Divine Magic:] All common spells, Shield, Rout, True (Weapon), Unstoppable Charge, Ward Camp.
\item[Special benefits:] Bonus die (+1B) for any test when leading others into Combat.
\end{description}
...
\item[Folk Magic:] Heal
\item[Divine Magic:] All common spells, Divine Heal, Resurrect.
\item[Special benefits:] Bonus die (+1B) to all Healing attempts.
\end{description}
...
\item[Folk Magic:] Detect Treasures of the Sea, Water Breath.
\item[Divine Magic:] All common spells, Call Undine, Breathe Water.
\item[Special benefits:] Bonus die (+1B) to all sailing checks made at sea, and Athletics checks made to swim. 
\end{description}
...
\item[Folk Magic:] Befuddle, Countermagic, Demoralise, Disruption, Ignite.
...
\item[Folk Magic:] Call Magic Spell spirit, Counter magic.
\item[Divine Magic:] All common spells, Reflection, Mindblast, Mindlink, Madness.
\item[Special benefits:] Bonus die (+1B) to any skill roll when dealing with Moon spirits.
\end{description}
...
\item[Folk Magic:] Multi Missile, Coordination, Clear Path, Speedart.
\item[Divine Magic:] All common spells, Sureshot, True (Bow or Spear).
\item[Special benefits:] Bonus die (+1B) Deception when stalking prey.
\end{description}
...
\begin{description}
	...
	\item[Duration (X):] The spell’s effects will stay in place for the number of minutes indicated.  Unless otherwise specified this will be 15 minutes.
...
\begin{rpg-spell}
{Fear}
{Instant, Magnitude 1, Ranged, Resist (Persistence)\\{[Religions: Chaos, Night]}}
...
\item[Success:] Victim is shaken and disturbed, suffering a Penalty die (-1P) to all skill tests for a number of Combat Rounds equal to 20 minus its POW (minimum of one Combat Round).
...
\item[Failure:] Victim gibbers and raves uncontrollably for a number of Combat Rounds equal to 20 minus its POW (minimum of one Combat Round). Victim will perform random Combat Actions during this period. Roll 1D6: (1) Move to close combat and attack a random target; (2) Run in a random direction; (3) Cast a spell at random target; (4) Use ranged attack against random target; (5) Shout at random target; (6) Change stance. 
\item[Success:] Victim is shaken and disturbed, suffering a Penalty die (-1P) to all skill tests for a number of Combat Rounds equal to 20 minus its POW (minimum of one Combat Round).
...
\begin{rpg-spell}
{Mischief}
{Magnitude 2, Touch, Resist (Persistence), Duration 15\\{[Religions: Trickster]}}
...
\item[9:] Victim smells of excrement (Penalty die (-1P) to Deception or Influence rolls).
\item[10:] Wobbles uncontrollably (Penalty die (-1P) to attacks, Athletics and any other roll involving dexterity).
\item[11:] The victim can only speak gibberish.
\item[12:] The victim says the most inappropriate things at the most socially awkward times. Penalty die (-1P) to any Influence rolls.
\item[13:] The victim falls asleep for 1D6 rounds on failed Persistence roll whenever they enter combat.
\item[14:] Makes loud flatulent noises whenever they move; Penalty die (-1P) to any Deception rolls.
\item[15:] The victim is compelled to tell the truth at all times.
\item[16:] No one ever takes the character seriously. Always has to make an Influence roll with a Penalty die (-1P) to convince others.
...
\begin{rpg-spell}
{Quicksand}
{Magnitude 2, Area, Resist (Persistence), Duration 15\\{[Religions: Earth]}}
...
The recipient of this spell glows with light and power. They gain two Bonus dice (+2B) to any Influence rolls for the duration of the spell. Also any light-hating creatures suffer a Penalty die (-1P) when attacking the recipient. 
\end{rpg-spell}
%\end{samepage}

% TODO REMOVE FOR LAYOUT PURPOSES (to reduce space and not go over a new page)
%\begin{figure}[h]
%\begin{center}
...
\item 6 - Hideous appearance that strikes fear into enemies (two Bonus dice (+2B) to Influence roll when Intimidating) or Beautiful appearance which charms all that behold them (two Bonus dice (+2B) to Influence rolls).
...
\begin{rpg-list}
\item 1-2: Carried up D10 metres (if already at the top, blown out the whirlwind the additional height before falling to earth (taking damage).
