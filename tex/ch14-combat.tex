...
\begin{description}
	...
	\begin{rpg-list}
	\item Determine Order: At the start of every combat, calculate the Combat Order of each character involved, which will determine the order in which they will act for the round. To calculate Combat Order add DEX and INT and divide by 2, then add 1D6 for some variability.
