...
The difference in SIZ between characters matters considerably. Consult table~\ref{tab:grappling-modifiers} for some guidelines. For greater differences the Games Master will determine if it makes sense to roll dice.
