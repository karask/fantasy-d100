...
In close combat a critical hit can cause two of the following effects: normal damage (can be selected twice for double weapon damage, 1D8 becomes 2D8), ignore armour, free attack, trip, disarm, knock-back or knockout.

In ranged combat a critical hit can also cause two effects but only normal damage (can be selected twice) and ignore armour effects are allowed.
