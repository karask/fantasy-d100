...
The most common spells of this type are: Hinder Skill (Perception), often used by thieves; Hinder Skill (Trade), used by the nastier traders; and Hinder Skill (Persistance) used by magicians against enemy spell-casters prior to casting spells upon them.
\end{rpg-spell}
