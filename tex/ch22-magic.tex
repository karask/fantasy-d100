...
%For every two points of Magnitude this spell increases the spiritual damage a character causes during Spirit Combat by one step (so a 1D4 becomes a D6, a D6 becomes a D8 and so forth), Persistence (or Folk Magic Casting for Shamans) is also increased by +10\% per two points of Magnitude.
\end{rpg-spell}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.40]{img/ai-images/tower.png}
\end{center}
\end{figure}
