...
Although Fantasy D100 is not a game of ‘Killing Things and Taking their Stuff’, it is sometimes useful and expected that creatures that the Player Characters meet upon their adventures will have treasure, both mundane and magical.
...
%Although the Fantasy D100 skill list has been designed to be as concise and complete as possible, during play or during the design of non-player characters for adventures, there may arise a desire to create new skills to describe a previously undiscovered ability. Before introducing a new skill, either by Gamemaster design or player request, consider these two points.
