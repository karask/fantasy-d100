...
Starting cash is 4D6 x 10 in Silver Pieces. In addition each character starts out with one of the two arms and armor packages below.

\begin{rpg-list}
	\item Leather armor, ranged weapon, close combat 2H weapon and dagger. 
	\item Leather armor, shield, ranged weapon, close combat 1H weapon and dagger.
\end{rpg-list}
