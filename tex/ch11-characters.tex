...
Fantasy D100 character generation is a seven step process and at each step the Player makes decisions about what their character is like at the beginning of the game, when the character is just starting out on their adventuring career. 
...
For Players that want a more scholarly character they can reduce Combat points to increase Knowledge points at a 1:2 ratio; thus for 10 Combat points a character can get 20 additional Knowledge points.
...
Select one or two skills that are below 90\% to be increased and split +5\% points to those skills. Skills that are close to mastery or at mastery, i.e. 90\% or more, require one improvement point for a +2\% in a single skill.
