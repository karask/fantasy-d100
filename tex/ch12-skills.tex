...
This chapter describes when and how to make skill tests, how to gain Bonus or Penalty dice on your skill depending upon the conditions the test is made under, and how to judge tests where two characters are competing against each other. Finally, a list of skills used in the game is detailed.
...
\begin{rpg-examplebox}
An apprentice potter (Craft 26\%) will, day in day out, produce a couple of pots of passable quality if working at his Master’s workshop. Of course, work beyond the skill of the character is still out of their reach, unless the player decides to take the chance with the dice and ask for a skill test.
\end{rpg-examplebox}
...
If the dice roll on a skill test is equal or less than the tens of the skill, then a critical success is achieved. 
...
\begin{rpg-examplebox}
When Rurik is jumping the chasm, his Athletics skill is 67\%  and therefore his chance of getting a critical is 6. Rob rolls a 4, which is less than the 6\% target for a critical success.  As a result, the Gamemaster rules that Rurik easily jumps the chasm with grace that allows him to carry on running without having to pause to catch his breath.
\end{rpg-examplebox}

\subsection{Fumbles}
Whenever a skill test results in a roll of 99 or 00, i.e. the two D10s both come up 0, then the player has fumbled. If the player's skill is greater than 100\% then a fumble occurs only with 00.
...
\section{Bonus/Penalty Dice}
Whenever circumastances make a skill roll easier or harder the player gains a Bonus or Penalty die. When a character has an Bonus die (+1B) in their roll they roll 2D10s for the tens and a D10 for the units. You keep the best roll for the tens to see if you rolled successfully. A Penalty die (-1P) means again rolling 2D10 for the tens but you keep the worse roll. It is possible to have multiple Bonus or Penalty dice, e.g. +2B, in which case you roll 3D10 for the tens and keep the best. Note, that if you get both a Bonus and a Penalty die they will cancel each other out.



\begin{rpg-examplebox}
  Whilst at the Royal Court, Rurik is asked to compose a clever and stimulating poem for the hard to please Count of Malvon. The Gamemaster asks Rurik to roll with a Penalty die. Rurik has Performance 35\% and rolls 3D10s (2D10 for the tens and a D10 for the units). He rolls 7, 5 for the tens and 1 for the units for a result of 51 which fails the test.

After displeasing the Count, Rurik tries to hurdle a small wall while being pursued by the Count’s guards. The Gamemaster rules that this is an easy task, so Rurik rolls with a Bonus die. He has an Athletics skill of 60\% and rolls 5, 2 for the tens and 9 for the units for a result of 29 which passes the check. 
\end{rpg-examplebox}

\subsection{Applying Bonus/Penalty dice}
\label{ssec:when-to-apply-difficulty-modifies}
Bonus and Penalty dice should only be applied when they have a significant effect on the character’s chance of success. Only apply when it is important and brings something to the story. 

Broadly speaking, there are three areas where the Gamemaster should grant a skill Bonus or Penalty die. The three areas are:
...
For example, climbing a steep cliff with natural hand holds and with the proper equipment (e.g. ropes and iron spikes) is a normal task. Doing the same climb in the pouring rain, will introduce a Penalty die (-1P) and if the character has also forgotten his ropes and spikes then this gives two Penalty dice (-2P).

In comparison, climbing a cliff where there are numerous ledges, and where the character can rest and actually walk up the cliff in places becomes very easy giving two Bonus dice (+2B).
...
Flynn’s Riders spend an extra couple of days in the city planning and preparing for the trip. They buy more than adequate supplies and equipment, along with the extra beasts of burden to carry them. Their scholars visit the local Temple of Knowledge and beg, borrow and steal maps of the Badlands, brought back by previous explorers. Finally, they manage to track down a guide, a survivor of a previous expedition, and persuade him to come along.  The Gamemaster awards them with two Bonus dice (+2B) to their Survival roll.

The Red Hand Gang makes the traditional preparations for any journey. They ensure they have enough supplies, but take no back up mounts or proper traveling clothing. In this case the Gamemaster asks for a normal Survival roll on account of their preparation.

Alber’s Lucky Five decide to live up to their name and simply decide, as soon as they hear about the lost temple, to ride out into the Badlands on the horses they arrived on, without replenishing supplies. The Gamemaster gives two Penalty dice (-2P) to their Survival roll as a result of their rashness.
\end{rpg-examplebox}



\subsubsection{As a result of Good Roleplaing}
This usually happens for skills that involve some form of communication, like Influence.  When the Player describes the action of their character, the exchange between their character and the non-player character(s) being influenced may be roleplayed out. If the player was entertaining, kept in character and added to the fun of the game, the Gamemaster may award them a Bonus die (+1B) or even two Bonus dice (+2B).  In exceptional circumstances, where the player reduced everyone to tears of laughter, or was outstanding in their portrayal of their character, the Gamemaster may waive the necessity for the skill test completely. Remember good storytelling always comes before any dice rolling. 
...
\label{ssec:opposed-tests-over-100}
In opposed skill tests a character with a skill over 100\% will reduce the difference of their skill to 100 from all participants, including themselves. 


\begin{rpg-examplebox}
  Grazum The Blackheart, an evil Orc Warlord is a Master Wrestler with an Athletics skill of 120\%.  Rurik, with an Athletics skill of 60\%, recklessly challenges him to an arm wrestling contest. In this opposed skill roll both skills will be reduced by 20\% (100\% and 40\% respectively) and then apply the opposed roll normally.
\end{rpg-examplebox}

\section{Assistance}
Characters will often have the opportunity to help each other during various skill tests. If one or more characters can assist and make a significant contribution then they can offer a Bonue die (+1B). On rare occasions the assistance will provide +2B (GMs discretion). The assisting character or characters must have the appropriate helping skill at a suitable level determined by the Gamemaster. How high this needs to be is usually dependant on the difficulty of the test. In most cases as long as the assisting character has a skill of at least Apprentice level (26\%+) then they can help.

\begin{rpg-examplebox}
Rurik is trying to force open an old and mouldy door. If Abnon with an Athletics of 50\% helps him, Rurik will roll Athletics with a Bonus die.
\end{rpg-examplebox}
...
Use of this skill without a healer’s kit incurs a two Penalty dice (-2P). Each use of the Healing skill generally takes a few minutes to perform. Both characters must remain stationary and may not use any actions while this occurs or they will lose the benefits of the healing. Typical types of injuries or ailments that may be treated are listed below:
...
Influence skill tests are normally opposed by a Perception, Persistence or Influence skill. They may be further influenced by how well a player roleplays the exchange. 
...
%A score in a Language skill of 76\% (Language Expert) or more will mean the character can also read and write in that language.
