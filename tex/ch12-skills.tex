...
If the dice roll on a skill test is equal or less than the tens of the modified skill, then a critical success is achieved. 
...
In opposed skill tests a character with a skill over 100\% (after applying modifiers) will reduce the difference of their skill to 100 from all participants, including themselves. 
...
Use of this skill without a healer’s kit incurs a -40\% penalty. Each use of the Healing skill generally takes a few minutes to perform. Both characters must remain stationary and may not use any actions while this occurs or they will lose the benefits of the healing. Typical types of injuries or ailments that may be treated are listed below:
